...
function modalBox() {
    $('a[rel*="extra"]').click(function (e) {
        ...
        if ($(this).is('a[href$=.png], a[href$=.jpg], a[href$=.gif], a[href$=.gif]')) {
            ...
            $('#modal_box').append('<div class="single figure"><div class="figcaption">' + title + '<button class="close">Закрыть</button></div><img src="../../../_projects/reklama-vliftah32/js/' + href + '" alt="" /></div>');
            $.getScript('/a/projects/reklama-vliftah32/js/modal-box.js');
...
function gallery() {
    $('a[rel*="gallery"]').click(function (e) {
		...
		figure.empty();
		figcaption.empty();
		figure.append('<img src="../../../_projects/reklama-vliftah32/js/' + href + '" alt="" />');
